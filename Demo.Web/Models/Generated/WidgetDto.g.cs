...
{
    public partial class WidgetDtoGen : GeneratedDto<Demo.Data.Models.Widget>
    {
        public WidgetDtoGen() { }

        private int? _WidgetId;
        private string _Name;
        private Demo.Data.Models.WidgetCategory? _Category;
        ...
        public Demo.Data.Models.WidgetCategory? Category
        {
            get => _Category;
        ...
        /// </summary>
        public override void MapFrom(Demo.Data.Models.Widget obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(Demo.Data.Models.Widget entity, IMappingContext context)
        {
            var includes = context.Includes;
        ...
        /// </summary>
        public override Demo.Data.Models.Widget MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new Demo.Data.Models.Widget()
            {
                Name = Name,
